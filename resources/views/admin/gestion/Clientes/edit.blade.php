...
@section('content')
    <div class="container">
        ...
        <h1 style="color: white">Editar Cliente: {{ $client->username }}</h1>
        ...
        @if ($client->role == 1)
            <div class="alert alert-danger">
                <i class="fas fa-lock"></i> **Acceso Restringido:** No se puede editar la información de un ADMINISTRADOR por
                    ...
                    <div class="col-md-6 d-flex justify-content-center align-items-center">
                        <div style="width: 100%; max-width: 500px; padding: 20px;">
                            <form action="{{ route('admin.gestion.clientes.update', $client->id) }}" method="POST">
                                ...
                                <h4 class="mt-4">Información de Cuenta</h4>
                                <p>
                                    <strong>Rol:</strong>
                                    @if ($client->role == 1)
