...
<body>
  ...
  <section id="banner" style="background: url('{{ asset('user-template/images/puppets/DIFUMINADO2.png') }}') no-repeat center center; background-size: cover;">
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              <a href="{{ url('single-product') }}"><img src="{{ asset('user-template/images/item1.jpg') }}" class="img-fluid rounded-4" alt="image"></a>
          ...
          <div class="swiper-slide">
            <div class="card position-relative">
              <a href="{{ url('single-product') }}"><img src="{{ asset('user-template/images/item2.jpg') }}" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="{{ url('single-product') }}">
                  <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                </a>
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              <a href="{{ url('single-product') }}"><img src="{{ asset('user-template/images/item3.jpg') }}" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="{{ url('single-product') }}">
                  <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                </a>
          ...
          <div class="swiper-slide">
            <div class="card position-relative">
              <a href="{{ url('single-product') }}"><img src="{{ asset('user-template/images/item4.jpg') }}" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="{{ url('single-product') }}">
                  <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                </a>
          ...
          <div class="swiper-slide">
            <div class="card position-relative">
              <a href="{{ url('single-product') }}"><img src="{{ asset('user-template/images/item7.jpg') }}" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="{{ url('single-product') }}">
                  <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                </a>
          ...
          <div class="swiper-slide">
            <div class="card position-relative">
              <a href="{{ url('single-product') }}"><img src="{{ asset('user-template/images/item8.jpg') }}" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="{{ url('single-product') }}">
                  <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                </a>
    ...
    <div class="container my-5 py-5">
      ...
      <div class="isotope-container row">
        ...
        <div class="item cat col-md-4 col-lg-3 my-4">
          <div class="card position-relative">
            <a href="{{ url('single-product') }}"><img src="{{ asset('user-template/images/item9.jpg') }}" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="{{ url('single-product') }}">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
        ...
        <div class="item dog col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            <a href="{{ url('single-product') }}"><img src="{{ asset('user-template/images/item10.jpg') }}" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="{{ url('single-product') }}">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
        ...
        <div class="item dog col-md-4 col-lg-3 my-4">
          <div class="card position-relative">
            <a href="{{ url('single-product') }}"><img src="{{ asset('user-template/images/item11.jpg') }}" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="{{ url('single-product') }}">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
        ...
        <div class="item cat col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            <a href="{{ url('single-product') }}"><img src="{{ asset('user-template/images/item12.jpg') }}" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="{{ url('single-product') }}">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
        ...
        <div class="item bird col-md-4 col-lg-3 my-4">
          <div class="card position-relative">
            <a href="{{ url('single-product') }}"><img src="{{ asset('user-template/images/item13.jpg') }}" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="{{ url('single-product') }}">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
        ...
        <div class="item bird col-md-4 col-lg-3 my-4">
          <div class="card position-relative">
            <a href="{{ url('single-product') }}"><img src="{{ asset('user-template/images/item14.jpg') }}" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="{{ url('single-product') }}">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
        ...
        <div class="item dog col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            <a href="{{ url('single-product') }}"><img src="{{ asset('user-template/images/item15.jpg') }}" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="{{ url('single-product') }}">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
        ...
        <div class="item cat col-md-4 col-lg-3 my-4">
          <div class="card position-relative">
            <a href="{{ url('single-product') }}"><img src="{{ asset('user-template/images/item16.jpg') }}" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="{{ url('single-product') }}">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
    ...
    <div class="container py-5 mb-5">
      ...
      <div class=" swiper bestselling-swiper">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <div class="card position-relative">
              <a href="{{ url('single-product') }}"><img src="{{ asset('user-template/images/item5.jpg') }}" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="{{ url('single-product') }}">
                  <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                </a>
          ...
          <div class="swiper-slide">
            <div class="card position-relative">
              <a href="{{ url('single-product') }}"><img src="{{ asset('user-template/images/item6.jpg') }}" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="{{ url('single-product') }}">
                  <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                </a>
  ...
  <section id="register" style="background: url('{{ asset('user-template/images/background-img.png') }}') no-repeat;">
    <div class="container ">
