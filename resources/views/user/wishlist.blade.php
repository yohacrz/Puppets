              ...
              <div class="cart-info d-flex flex-wrap align-items-center ">
                <div class="col-lg-3">
                  <div class="card-image">
                    <img src="{{ asset('user-template/images/item2.jpg') }}" alt="cloth" class="img-fluid">
                  </div>
                </div>
                <div class="col-lg-9">
          ...
          <tr>
            <td class="py-4">
              <div class="cart-info d-flex flex-wrap align-items-center ">
                <div class="col-lg-3">
                  <div class="card-image">
                    <img src="{{ asset('user-template/images/item11.jpg') }}" alt="cloth" class="img-fluid">
                  </div>
                </div>
                <div class="col-lg-9">
                  <div class="card-detail ps-3">
          ...
          <tr>
            <td class="py-4">
              <div class="cart-info d-flex flex-wrap align-items-center ">
                <div class="col-lg-3">
                  <div class="card-image">
                    <img src="{{ asset('user-template/images/item14.jpg') }}" alt="cloth" class="img-fluid">
                  </div>
                </div>
                <div class="col-lg-9">
                  <div class="card-detail ps-3">
          ...
          <tr>
            <td class="py-4">
              <div class="cart-info d-flex flex-wrap align-items-center ">
                <div class="col-lg-3">
                  <div class="card-image">
                    <img src="{{ asset('user-template/images/item7.jpg') }}" alt="cloth" class="img-fluid">
                  </div>
                </div>
                <div class="col-lg-9">
                  <div class="card-detail ps-3">
