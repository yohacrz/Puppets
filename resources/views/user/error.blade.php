    ...
    <section id="banner" class="py-3" style="background: #F9F3EC;">
        <div class="container py-5 my-3">
            <div class="hero-content py-5 my-3">
                <h2 class="display-1 mt-3 mb-0">Error <span class="text-primary"> 404 </span></h2>
                <p>Sorry! Page that you are looking for is not available.</p>
                <a href="{{ url('/') }}" class="btn btn-outline-dark btn-lg text-uppercase fs-6 px-4 py-3 rounded-1 mt-4">
                    Go Back Home
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-6 text-md-end">
                    <p class="secondary-font">Free HTML Template by <a href="https://templatesjungle.com/"
                            target="_blank" class="text-decoration-underline fw-bold text-black-50"> TemplatesJungle</a>
                    </p>
                </div>
            </div>
        </div>
