                ...
                <main class="col-md-9">
                    ...
                    <div class="product-grid row ">
                        <div class="col-md-4 my-4">
                            <div class="card position-relative">
                                <a href="{{ url('single-product') }}"><img
                                        src="{{ asset('user-template/images/item7.jpg') }}"
                        ...
                        <div class="col-md-4 my-4">
                            ...
                            <div class="card position-relative">
                                <a href="{{ url('single-product') }}"><img
                                        src="{{ asset('user-template/images/item10.jpg') }}"
                                        class="img-fluid rounded-4" alt="image"></a>
                                <div class="card-body p-0">
                                    <a href="{{ url('single-product') }}">
                                        <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                        ...
                        <div class="col-md-4 my-4">
                            <div class="card position-relative">
                                <a href="{{ url('single-product') }}"><img
                                        src="{{ asset('user-template/images/item5.jpg') }}"
                                        class="img-fluid rounded-4" alt="image"></a>
                                <div class="card-body p-0">
                                    <a href="{{ url('single-product') }}">
                                        <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                        ...
                        <div class="col-md-4 my-4">
                            ...
                            <div class="card position-relative">
                                <a href="{{ url('single-product') }}"><img
                                        src="{{ asset('user-template/images/item8.jpg') }}"
                                        class="img-fluid rounded-4" alt="image"></a>
                                <div class="card-body p-0">
                                    <a href="{{ url('single-product') }}">
                                        <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                        ...
                        <div class="col-md-4 my-4">
                            <div class="card position-relative">
                                <a href="{{ url('single-product') }}"><img
                                        src="{{ asset('user-template/images/item13.jpg') }}"
                                        class="img-fluid rounded-4" alt="image"></a>
                                <div class="card-body p-0">
                                    <a href="{{ url('single-product') }}">
                                        <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                        ...
                        <div class="col-md-4 my-4">
                            <div class="card position-relative">
                                <a href="{{ url('single-product') }}"><img
                                        src="{{ asset('user-template/images/item14.jpg') }}"
                                        class="img-fluid rounded-4" alt="image"></a>
                                <div class="card-body p-0">
                                    <a href="{{ url('single-product') }}">
                                        <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                        ...
                        <div class="col-md-4 my-4">
                            ...
                            <div class="card position-relative">
                                <a href="{{ url('single-product') }}"><img
                                        src="{{ asset('user-template/images/item9.jpg') }}"
                                        class="img-fluid rounded-4" alt="image"></a>
                                <div class="card-body p-0">
                                    <a href="{{ url('single-product') }}">
                                        <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                        ...
                        <div class="col-md-4 my-4">
                            <div class="card position-relative">
                                <a href="{{ url('single-product') }}"><img
                                        src="{{ asset('user-template/images/item16.jpg') }}"
                                        class="img-fluid rounded-4" alt="image"></a>
                                <div class="card-body p-0">
                                    <a href="{{ url('single-product') }}">
                                        <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                        ...
                        <div class="col-md-4 my-4">
                            <div class="card position-relative">
                                <a href="{{ url('single-product') }}"><img
                                        src="{{ asset('user-template/images/item2.jpg') }}"
                                        class="img-fluid rounded-4" alt="image"></a>
                                <div class="card-body p-0">
                                    <a href="{{ url('single-product') }}">
                                        <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
