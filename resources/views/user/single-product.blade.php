...
<body>
              ...
              <div class="swiper product-large-slider">
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <img src="{{ asset('user-template/images/blog-lg4.jpg') }}" class="img-fluid" />
                  </div>
                  <div class="swiper-slide">
                    <img src="{{ asset('user-template/images/blog-lg2.jpg') }}" class="img-fluid" />
                  </div>
                  <div class="swiper-slide">
                    <img src="{{ asset('user-template/images/blog-lg3.jpg') }}" class="img-fluid" />
                  </div>
                  <div class="swiper-slide">
                    <img src="{{ asset('user-template/images/blog-lg1.jpg') }}" class="img-fluid" />
                  </div>
            ...
            <div class="col-md-12 mt-2">
              <div thumbsSlider="" class="swiper product-thumbnail-slider">
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide">
                    <img src="{{ asset('user-template/images/item7.jpg') }}" class="img-fluid" />
                  </div>
                  <div class="swiper-slide">
                    <img src="{{ asset('user-template/images/item1.jpg') }}" class="img-fluid" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="tab-pane fade" id="v-pills-reviews" role="tabpanel" aria-labelledby="v-pills-reviews-tab"
              ...
              <div class="review-box d-flex flex-wrap">
                <div class="col-lg-6 d-flex flex-wrap gap-3">
                  <div class="col-md-2">
                    <div class="image-holder">
                      <img src="{{ asset('user-template/images/reviewer-1.jpg') }}" alt="review" class="img-fluid rounded-circle">
                    </div>
                  </div>
                  <div class="col-md-8">
                ...
                <div class="col-lg-6 d-flex flex-wrap gap-3">
                  <div class="col-md-2">
                    <div class="image-holder">
                      <img src="{{ asset('user-template/images/reviewer-2.jpg') }}" alt="review" class="img-fluid rounded-circle">
                    </div>
                  </div>
                  <div class="col-md-8">
                    <div class="review-content">
  ...
  <section id="register" style="background: url('{{ asset('user-template/images/background-img.png') }}') no-repeat;" class="my-5">
