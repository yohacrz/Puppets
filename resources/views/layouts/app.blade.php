...
<head>
    ...
    <link href="{{ asset('plugins/lib/flaticon/font/flaticon.css') }}" rel="stylesheet">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        <a href="{{ url('/') }}" class="navbar-brand ms-lg-5">
            <img src="{{ asset('img/user/VARIANTE DE LOGOS PUPPETS-05.png') }}" alt="Logo Puppets" style="height: 80px;">
        </a>
    ...
    <div class="container-fluid bg-light mt-5 py-5">
        <div class="container pt-5">
            <div class="row g-5">
                <!-- Aquí copia y pega el contenido del footer que tienes, usando asset() para las imágenes/icons -->
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        ...
                        <a class="text-body mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Servicios</a>
